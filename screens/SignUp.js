        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.container}>
                ...
                <Formik
                    ...
                    onSubmit={(values) => handlerSingUp(values.email, values.password)}
                >
                    {
                        (formikProps) => (
                            <View style={{width: '100%', alignItems: "center"}}>
                                ...
                                {/* Email field */}
                                <TextInput
                                    style={[globalStyles.text_input, {marginTop: 20}]}
                                ...
                                <View style={[globalStyles.text_input, {
                                    ...
                                    <View style={{flex: 1}}>
                                        <TouchableOpacity onPress={() => setShowPass(!showPass)}>
                                            <MaterialCommunityIcons name={showPass ? "eye-off" : "eye"}
                                                                    color={'gray'}
                                                                    size={18}/>
                                        </TouchableOpacity>
                                    </View>
                                ...
                                />
                                <Text style={{color: colors.error}}>
                                    {formikProps.touched.passwordRepeat && formikProps.errors.passwordRepeat}
                                </Text>
