...
export default function SignIn() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput style={globalStyles.text_input} placeholder={'Email'} onChangeText={(text) => setEmail(text)}/>
            ...
            <TouchableOpacity style={[globalStyles.bt, {marginTop: 60}]} onPress={handleLogin}>
